                  ...
                  <td style={{ padding: "5px 0" }}>
                    <div style={{ textAlign: "center", padding: "0 20px" }}>
                      <div style={{ maxWidth: "204px", margin: "0 auto" }}>
                        ...
                        alt="Logo"
                        /> */}
                          <img alt="Logo" height="auto" src="https://res.cloudinary.com/doms0ft46/image/upload/v1741276653/snaapify_black_mbkmun.png" style={{ display: "block", height: "auto", border: "0", width: "100%" }} width="204"/>
                        </a>
                      </div>
                    </div>
                  </td>
                  ...
                  <td style={{ padding: "5px 0" }}>
                    ...
                    <div style={{ textAlign: "center", padding: "5px 0" }}>
                      <div style={{ maxWidth: "170px", margin: "0 auto" }}>
                        <img alt="Footer Banner" height="auto" src="https://res.cloudinary.com/doms0ft46/image/upload/v1741276652/Secondary_Logo_csatsr.png" style={{ display: "block", height: "auto", border: "0", width: "100%" }} width="170"/>
                      </div>
                    </div>

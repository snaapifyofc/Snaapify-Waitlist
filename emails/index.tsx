...
import {} from "../assets/images/Banner.png"
                  ...
                  <td style={{ padding: "5px 0" }}>
                    <div style={{ textAlign: "center", padding: "0 20px" }}>
                      <div style={{ maxWidth: "204px", margin: "0 auto" }}>
                        ...
                        {/* <Img
                        src='/assets/images/snaapify_black.png'
                        width="204"
                        height="auto"
                        alt="Logo"
                        /> */}
                          <img alt="Logo" height="auto" src="/assets/images/snaapify_black.png" style={{ display: "block", height: "auto", border: "0", width: "100%" }} width="204"/>
                        </a>
                      </div>
                    </div>
                  </td>
...
//                         <a href="https://www.example.com" style={{ outline: "none" }} target="_blank">
//                         <Img
//                         src="https://res.cloudinary.com/doms0ft46/image/upload/v1741276653/snaapify_black_mbkmun.png"
//                         width="204"
//                         height="auto"
//                         alt="Logo"
//                         />
...
//                     <div style={{ margin: "20px 0", textAlign: "center" }}>
//                       <div style={{ maxWidth: "680px" }}>
//                         <Img alt="Snaapify Banner" height="auto" src="https://res.cloudinary.com/doms0ft46/image/upload/v1741276656/Banner_voy04a.png" style={{ display: "block", height: "auto", border: "0", width: "100%" }} width="680"/>
//                       </div>
//                     </div>
...
//                     <div style={{ textAlign: "center", padding: "5px 0" }}>
//                       <div style={{ maxWidth: "170px", margin: "0 auto" }}>
//                         <Img alt="Footer Logo" height="auto" src="https://res.cloudinary.com/doms0ft46/image/upload/v1741276652/Secondary_Logo_csatsr.png" style={{ display: "block", height: "auto", border: "0", width: "100%" }} width="170"/>
//                       </div>
//                     </div>
